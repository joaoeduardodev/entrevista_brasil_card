        ...
        <table class=" table table-striped">
                ...
                <tbody>
                    ...
                    foreach ($result as $row) {
                        ...
                        <td>' . $row['cargo'] . '</td>
                        <td>' . $row['setor'] . '</td>
                        <td><a type="button" href="telaAtualizacao.php?idFuncionario=' . $row['idFuncionarios'] . '" class="btn btn-primary">Alterar</a></td>
                        <td><a type="button" href="excluir.php?idFuncionario=' . $row['idFuncionarios'] . '" class="btn btn-danger">Deletar</a></td>
                        </tr>';
                    }
